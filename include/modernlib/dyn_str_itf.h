 ...
 *
 * @param nts a null-termianted string, if the string is `NULL`, an empty string is created
...
static inline dyn_string_result_type_name dyn_string_func(move_from_nts_stdalloc)(dyn_string_character_type **nts)
{
    return dyn_string_func(move_from_nts)(nts, std_allocator);
}
